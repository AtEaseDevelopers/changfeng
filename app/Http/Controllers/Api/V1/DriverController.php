...
class DriverController extends Controller
{
            ...
            if(!empty($driver)){
                ...
                if($status){
                    if($session == null){
                        ...
                        return response()->json([
                                'result' => true,
                                'message' => 'api.message.previous_session_override',
                                'data' => [
                                    'driver' => $driver,
                                    'trip' => [
                                        'status' => true,
                ...
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.invalid_credential',
                    'data' => null
                ], 401);
            }
        }
    ...
    public function logout(Request $request){
        try{
            ...
            if(!empty($driver)){
                ...
                return response()->json([
                    'result' => false,
                    'message' => 'Invalid Session',  //'api.message.invalid_session',
                    'data' => null
                ], 401);
            }
        }
    ...
    public function session(Request $request){
        try{
            ...
            if(!empty($driver)){
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.session_found',
        ...
        try{
            ...
            if(!empty($trip)){
                if($trip->type == 2){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.trip_had_not_started',
                        'data' => null
                    ], 400);
                }
            }else{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.driver_location_had_been_updated_successfully',
                'data' => $DriverLocation
            ], 200);
        }
        catch(Exception $e){
        ...
        try{
            ...
            if(!empty($trip)){
                if($trip->type == 2){
                    ...
                    return response()->json([
                        'result' => true,
                        'message' => 'api.message.trip_had_started',
                        'data' => [
                            'status' => true,
                            'trip' => $trip
                        ]
    ...
    public function starttrip(Request $request){
        try{
            ...
            if(empty($lorry)){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.invalid_lorry',
                    'data' => null
                ], 400);
            }
            //process
            ...
            if(!empty($trip)){
                if($trip->type == 2){
                    ...
                    return response()->json([
                        'result' => true,
                        'message' => 'api.message.trip_had_been_started_successfully',
                        'data' => $newtrip
                    ], 200);
                }else{
                    return response()->json([
                ...
                if($trip->type == 2){
                    ...
                    foreach($data["wastage"] as $wastage) {
                        ...
                        if(empty($inventorybalance)){
                            ...
                            return response()->json([
                                'result' => false,
                                'message' => 'Wastage quantity more than available quantity',
                                'data' => null
                            ], 400);
                        }else{
                    ...
                    return response()->json([
                        'result' => true,
                        'message' => 'Trip had been ended successfully',
                        'data' => $newtrip
                    ], 200);
                }
            }else{
    ...
    public function trip(Request $request){
        ...
        if(!($data['type'] == 1 || $data['type'] == 2)){
            return response()->json([
               'result' => false,
                'message' => 'api.message.invalid_type',
                'data' => null
            ], 400);
        }
        //process
        ...
        if($data['type'] == 1){
            ...
            if(!empty($trip)){
                if($trip->type == 2){
                    ...
                    return response()->json([
                        'result' => true,
                        'message' => 'api.message.trip_had_been_ended_successfully',
                        'data' => $newtrip
                    ], 200);
                }
            }else{
    ...
    public function getkelindan(Request $request){
        try{
            ...
            if(count($kelindan) != 0){
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.kelindan_found',
                    'data' => $kelindan
                ], 200);
            }else{
                return response()->json([
                    'result' => false,
                    'message' => 'Kelindan not found',//'api.message.kelindan_not_found',
                    'data' => null
                ], 200);
            }
        }
    ...
    public function getlorry(Request $request){
        try{
            ...
            if(count($lorry) != 0){
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.lorry_found',
                    'data' => $lorry
                ], 200);
            }else{
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.lorry_not_found',
                    'data' => null
                ], 200);
            }
        }
    ...
    public function gettask(Request $request){
        try{
            ...
            if($message){
                ...
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.task_not_found',
                    'data' => [
                        'task' => null,
                        'stock' => $inventorybalance
                    ]
    ...
    public function starttask(Request $request){
        try{
            ...
            if(empty($task)){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.invalid_task',
                    'data' => null
                ], 400);
            }else{
                if($task->status == 8){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.task_had_been_completed',
                        'data' => null
                    ], 400);
                }
                if($task->status == 9){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.task_had_been_cancelled',
                        'data' => null
                    ], 400);
                }
                if($task->status == 1){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.task_had_been_in_progress',
                        'data' => null
                    ], 400);
                }
            }
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.task_had_been_started_successfully',
                'data' => $task
            ], 200);
        }
        catch(Exception $e){
    ...
    public function canceltask(Request $request){
        try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.task_had_been_cancelled_successfully',
                'data' => $task
            ], 200);
        }
        catch(Exception $e){
        ...
        try{
            ...
            if(isset($data['customer_id'])){
                ...
                if(empty($customer)){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.invalid_customer',
                        'data' => null
                    ], 400);
                }
            }
            ...
            if(isset($data['customer_id'])){
                ...
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.product_found',
                    'data' => $product
                ], 200);
            }else{
                $product = DB::table('products')
    ...
    public function getcustomer(Request $request){
        try{
            ...
            if(count($customer) != 0){
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.customer_found',
                    'data' => $customer
                ], 200);
            }else{
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.customer_not_found',
                    'data' => null
                ], 200);
            }
        }
    ...
    public function customermakepayment(Request $request){
        try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.payment_insert_successfully_found',
                'data' => $invoicepayment
            ], 200);
        }
        catch(Exception $e){
    ...
    public function customerinvoice(Request $request){
        try{
            ...
            if(empty($invoice)){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.invoice_not_found',
                    'data' => null
                ], 200);
            }else{
            ...
            catch(Exception $ex)
            {
               ...
               //$invoice->newcredit = round(DB::select('call ice_spGetCustomerCreditByDate("'.$invoice->updated_at.'",'.$invoice->customer_id.');')[0]->credit,2);
                ...
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.invoice_found',
                    'data' => $invoice
                ], 200);
            }
        }
    ...
    public function customerpayment(Request $request){
        ...
        if(empty($invoicepayment)){
            return response()->json([
                'result' => false,
                'message' => 'api.message.invoice_payment_not_found',
                'data' => null
            ], 200);
        }else{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.invoice_payment_found',
                'data' => $invoicepayment
            ], 200);
        }
    }
        ...
        try{
            ...
            foreach($data['invoicedetail'] as $id){
                ...
                if(empty($product)){
                    return response()->json([
                        'result' => false,
                        'message' => 'api.message.invalid_product',
                        'data' => null
                    ], 400);
                    DB::rollback();
                }
           ...
           //$iv->newcredit = round(DB::select('call ice_spGetCustomerCreditByDate("'.date('Y-m-d H:i:s').'",'.$iv->customer_id.');')[0]->credit,2);
            ...
            return response()->json([
                'result' => true,
                'message' => 'Invoice add successfully', //'api.message.invoice_add_successfully',
                'data' => $iv
            ], 200);
        }
        catch(Exception $e){
      ...
      public function invoicepdf(Request $request)
	{
	    try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.load_success',
                'data' => $url
            ], 200);
        }
        catch(Exception $e){
    ...
    public function getstock(Request $request){
        try{
            ...
            if(count($inventorybalance) == 0){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.no_stock_found',
                    'data' => null
                ], 200);
            }else{
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.stock_found',
    ...
    public function listotherdriver(Request $request){
        try{
            ...
            if(count($drivers) == 0){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.no_driver_found',
                    'data' => null
                ], 200);
            }else{
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.driver_found',
                    'data' => $drivers
                ], 200);
            }
        }
    ...
    public function transferstock(Request $request){
        ...
        if(!empty($totrip)){
            if($totrip->type == 2){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.selected_driver_trip_had_not_started',
                    'data' => null
                ], 400);
            }
        }else{
        ...
        try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'Pending driver accept transfer', //'api.message.pending_driver_accept_transfer',
                'data' => null
            ], 200);
        }
        catch(Exception $e){
    ...
    public function gettransfer(Request $request){
        try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'api.message.transfer_found',
                'data' => [
                    'request' => $request,
                    'pending' => $pending
                ]
    ...
    public function updatetransfer(Request $request){
        ...
        if(empty($inventorytransfer)){
            return response()->json([
               'result' => false,
                'message' => 'api.message.transfer_not_found',
                'data' => null
            ], 400);
        }
        if($inventorytransfer->status == 2){
            return response()->json([
              'result' => false,
              'message' => 'api.message.transfer_already_accepted',
                'data' => null
            ], 400);
        }
        if($inventorytransfer->status == 3){
            return response()->json([
              'result' => false,
              'message' => 'api.message.transfer_already_rejected',
              'data' => null
            ], 400);
        }
        ...
        if(empty($fromdriver)){
            return response()->json([
              'result' => false,
              'message' => 'api.message.from_driver_not_found',
                'data' => null
            ], 400);
        }
        ...
        if(empty($fromdriver)){
            return response()->json([
              'result' => false,
              'message' => 'api.message.to_driver_not_found',
                'data' => null
            ], 400);
        }
        //process
        try{
            ...
            if($data['status'] == 3){
                ...
                return response()->json([
                   'result' => false,
                    'message' => 'api.message.transfer_rejecet_successfully',
                    'data' => null
                ], 200);
            }
            if($data['status'] == 2){
                ...
                $inventorytransfer->save();
                 ...
                 return response()->json([
                    'result' => false,
                    'message' => 'api.message.transfer_accept_successfully',
                     'data' => null
                 ], 200);
            }
        }
    ...
    public function getstocktransaction(Request $request){
        try{
            ...
            if($data['date'] > date('Y-m-d H:i:s')){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.date_cannot_be_future_date',
                    'data' => null
                ], 400);
            }
            //process
            ...
            if(count($finalinventorytransaction) == 0){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.transaction_not_found',
                    'data' => null
                ], 200);
            }else{
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.transaction_found',
    ...
    public function listalldriver(Request $request){
        try{
            ...
            if(count($driver) == 0){
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.invalid_driver',
                    'data' => null
                ], 200);
            }else{
                return response()->json([
    ...
    public function pushdrivertask(Request $request){
        ...
        try{
            ...
            return response()->json([
                'result' => true,
                'message' => 'Push Task Successfully', // 'api.message.push_task_successfully',
                'data' => null
            ], 200);
        }
        catch(Exception $e){
    ...
    public function listtranfer(Request $request){
        ...
        try{
            ...
            if(!empty($tasktransfer)){
                return response()->json([
                    'result' => true,
                    'message' => 'api.message.task_transfer_found',
                    'data' => $tasktransfer
                ], 200);
            }else{
                return response()->json([
                    'result' => false,
                    'message' => 'api.message.task_transfer_not_found',
                    'data' => null
                ], 200);
            }
        }
    ...
    public function dashboard_bk(Request $request){
        try{
            ...
            return response()->json([
                'result' => false,
                'message' => 'api.message.get_dashboard_successfully',
                'data' => $result
            ], 200);
        }
        catch(Exception $e){
    ...
    public function getTranslations(Request $request)
    {
        ...
        return response()->json([
                'result' => true,
                'message' => 'api.message.language_update_successfully',
                'data' => $result
            ], 200);
