...
<div class="form-group col-sm-6">
    ...
    {{ Form::select('source', array(0 => 'No', 1 => 'Yes'), null, ['class' => 'form-control']) }}
</div>

<!-- Destination Field -->
<div class="form-group col-sm-6">
    {!! Form::label('destination', 'Destination:') !!}
    {{ Form::select('destination', array(0 => 'No', 1 => 'Yes'), null, ['class' => 'form-control']) }}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::textarea('address1', null, ['class' => 'form-control','rows'=>'1']) !!}
</div>

<!-- Address2 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('address2', 'Address2:') !!}
    {!! Form::textarea('address2', null, ['class' => 'form-control','rows'=>'1']) !!}
</div>

<!-- Address3 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('address3', 'Address3:') !!}
    {!! Form::textarea('address3', null, ['class' => 'form-control','rows'=>'1']) !!}
</div>

<!-- Address4 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('address4', 'Address4:') !!}
    {!! Form::textarea('address4', null, ['class' => 'form-control','rows'=>'1']) !!}
</div> --}}
